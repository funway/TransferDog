...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon11 = QIcon()
        icon11.addFile(u"transfer_dog/resource/img/settings-4-line.png", QSize(), QIcon.Normal, QIcon.Off)
...
#if QT_CONFIG(tooltip)
        self.actionSettings.setToolTip(QCoreApplication.translate("MainWindow", u"Open application settings dialog", None))
#endif // QT_CONFIG(tooltip)
